...
//     const confirmPassInput = document.getElementById("confirmPassW");
//     const phoneInput = document.getElementById("phone");
//     const ageInput = document.getElementById("age"); 
//     const nameInputs = document.querySelectorAll("#fName, #lName");
//     const loginPageBtn = document.getElementById("togToLog");
//     const regPageBtn = document.getElementById("togToReg");
...
//         if (parseInt(ageInput.value)  <= 18 || ageInput.value.trim() === "") {
...
//             alert("Please correct the errors before submitting the form.");
//         } else {
//             alert("Form submitted successfully!"); // Debugging purpose
...
//             span.className = "error-message invalid";
...
//     regPageBtn.addEventListener("click" , (e)=>{
//         e.preventDefault()
